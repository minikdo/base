...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- Volume Mute
    , ((0  , xF86XK_AudioMute        ), spawn "pa_switch_carbon --sink-mute-toggle")

    -- Volume Up
    , ((0  , xF86XK_AudioRaiseVolume ), spawn "pa_switch_carbon --volume-up")

    -- Volume Down
    , ((0  , xF86XK_AudioLowerVolume ), spawn "pa_switch_carbon --volume-down")

    -- Mic Toggle
    , ((0  , 0x1008FFB2              ), spawn "pa_switch_carbon --mic-toggle")
